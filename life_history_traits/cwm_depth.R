...
rls_avg_subset = rls_avg %>% 
  select(latitude, longitude, survey_date, depth_bin, species_name, valid_name, biomass_mean, total_mean)
...
# save data
write.csv(trait_cwm,"~/projects/msc_thesis/data/cwm_depth_data.csv", row.names = FALSE)
write.csv(trait_cwm,"/media/mari/Crucial X8/cwm_depth_data.csv", row.names = FALSE)
